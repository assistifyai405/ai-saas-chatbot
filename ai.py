...
app = Flask(__name__)
app.secret_key = os.getenv("SECRET_KEY", "assistify-super-secret-key-change-this")
    ...
    <div class="card">
      ...
      <div class="grid-4">
        ...
        <div class="mini-card">
          ...
          <p>Verkoop abonnementen via duidelijke SaaS plannen.</p>
        </div>
      </div>
    </div>
...
def widget_js():
    js = """
(function () {
  console.log("Assistify widget placeholder loaded");
})();
"""
